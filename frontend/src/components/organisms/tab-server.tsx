...
export default function ServerTab() {
    return (
        <Flex direction="column" maxW="658px">
            <Text fontFamily="secondary" fontSize="48px" lineHeight="shorter" fontWeight="normal">
                Server
            </Text>
            <Flex direction="column" gap="32px" mt="56px">
                ...
                <Flex justifyContent="space-between" gap="32px">
                    ...
                    <Text fontSize="xs" color="grey.400" lineHeight="shorter" maxW="210px">
                        failures wact only all detectable era the statubled, a in action transaction
                        receipt. Disabling this feature will make Ganache handle transaction
                        failures like other Ethereum clients.
                    </Text>
                </Flex>
                <Divider />
