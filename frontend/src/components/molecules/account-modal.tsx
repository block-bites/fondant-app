      ...
      <Center>
        <ModalContent>
          ...
          <ModalBody>
            <Stack spacing="16px">
              <Stack spacing="8px">
                <Text fontSize="lg" lineHeight="tall" fontWeight="normal" color="grey.border">
                  PUBLIC KEY
                </Text>
                <Text fontSize="sm" lineHeight="tall" fontWeight="light" color="grey.border">
                  {publicKey}
                </Text>
              </Stack>
              <Stack spacing="8px">
              ...
              <Box>
                <Text fontSize="md" lineHeight="tall" fontWeight="normal" color="#F00">
