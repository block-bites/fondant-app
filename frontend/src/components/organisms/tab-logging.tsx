      ...
      <Flex direction="column" gap="24px">
        ...
        <Flex alignItems="flex-start">
          ...
          <Text fontSize="sm" w="450px" color="grey.400">
            We use Google Analytics to track Fondant usage. This information
            tracking 15 anymous. get o not track chsons ty da ntifiable
            information, account data or private keys. Note: This setting is
            global and will persist between workspaces.
          </Text>
        </Flex>
      </Flex>
    </Flex>
