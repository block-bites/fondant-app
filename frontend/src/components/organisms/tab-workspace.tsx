...
export default function WorkspaceTab() {
    return (
        <Flex direction="column" maxW="654px">
            ...
            />
            <Text fontSize="xs" color="grey.400" mt="16px" lineHeight="shorter">
                Link Truffle projects to this workspace by adding their truffle-config.js or
                truffle.js file to this workspace. This will show useful contract and event data to
