...
import { Flex, TabList, Tab, Tabs, TabPanel, TabPanels, Divider, Button } from "@chakra-ui/react"
...
export default function Settings() {
    ...
    return (
        <>
            <Helmet>
                <title>Fondant | Settings</title>
            </Helmet>
            <Tabs variant="enclosed">
                <Flex justifyContent="center" direction="column" alignItems="center" m="32px 0">
